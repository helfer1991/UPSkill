...
public class Tempo {
    ...
    private static final int HORA_OMISSO = 0;
    private static final int MINUTO_OMISSO = 0;
    private static final int SEGUNDO_OMISSO = 0;
     ...
     */
    public Tempo() {
        this.hora = HORA_OMISSO;
        this.minuto = MINUTO_OMISSO;
        this.segundo = SEGUNDO_OMISSO;
    }            
